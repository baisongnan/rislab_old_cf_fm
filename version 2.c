...
const char * V_SLOCAL_REVISION="61";
const char * V_SREVISION="a2e1940a86f4";
const char * V_STAG="2021.01 +61";
const char * V_BRANCH="jumpingrobot_servo";
const bool V_MODIFIED=true;
const bool V_PRODUCTION_RELEASE=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xa2e1940a;
const uint16_t V_REVISION_1=0x86f4;
